...
//   * Every shift is paid once on the weekday it STARTED (a Sunday night
//     finishing Monday is one Sunday shift). Shifts dated outside the pay
//     week are included by default and listed on the run; the import form
//     can opt to skip them (partitionShiftsByPeriod).
//
