...
const SOPS = [
  ...
  // The remaining SOPs ship as empty containers — admin uploads the matching
  // PDF via /induction/admin/sop-documents and picks the SOP from the
  // dropdown. The PDF then renders inline on the sign page. If you want a
  // structured fallback (e.g. before a PDF is uploaded), add a `sections`
  // array here following the pattern above.
  {
    slug: 'stop-slow',
    title: 'Controlling Traffic with a Stop-Slow Bat',
    code: 'HSE 04.02.53',
    revision: '1',
    summary: 'Using a stop-slow bat to control traffic at a worksite — positioning, signalling and communication.',
    pdfFilenameMatch: /04\.02\.53|stop.?slow/i,
    imageFolder: '/images/sop/stop-slow',
    sections: [],
  },
  {
    slug: 'two-way-radio',
    ...
    code: 'HSE 04.02.54',
    revision: '1',
    summary: 'How to use two-way radios safely and effectively — channel discipline, call signs and protocols.',
    pdfFilenameMatch: /04\.02\.54|two.?way|radio/i,
    imageFolder: '/images/sop/radio',
    sections: [],
  },
  {
    slug: 'drop-deck',
    title: 'Drop Deck Operations (AU)',
    code: 'HSE 04.02.61',
    revision: '1',
    summary: 'Loading, securing and unloading drop-deck vehicles safely.',
    pdfFilenameMatch: /04\.02\.61|drop.?deck/i,
    imageFolder: '/images/sop/drop-deck',
    sections: [],
  },
  {
    slug: 'swms',
    ...
    code: 'SWMS',
    revision: '1',
    summary: 'The overarching SWMS covering high-risk traffic management activities.',
    pdfFilenameMatch: /swms/i,
    imageFolder: '/images/sop/swms',
    sections: [],
  },
];
