...
const employeeGuideSlides = [
  {
    ...
    content: '<div class="text-center"><p class="text-2xl text-blue-600 mb-4">Module 1</p><p class="text-lg text-gray-600">Welcome to T&S Traffic Control</p></div>',
    layout: 'title',
    icon: '📘'
  },
  {
    ...
    content: '<div class="grid md:grid-cols-2 gap-8"><div><p class="text-xl leading-relaxed mb-4">T&S Traffic Control — <strong>"A Safe Way Home."</strong></p><p class="text-lg text-gray-600">Raising standards of safety, professionalism, and respect in NSW traffic control.</p></div><div class="bg-blue-600 text-white rounded-2xl p-6"><p class="text-lg mb-3 font-semibold">What drives us:</p><ul class="space-y-3"><li class="flex items-start gap-3"><span class="text-green-300 text-xl">✓</span> ISO-certified operations</li><li class="flex items-start gap-3"><span class="text-green-300 text-xl">✓</span> Built to make a difference</li><li class="flex items-start gap-3"><span class="text-green-300 text-xl">✓</span> Protecting lives every day</li></ul></div></div>',
    layout: 'split',
    icon: '🎯'
  },
  {
    title: 'Who We Are',
    subtitle: '',
    content: '<div class="max-w-3xl mx-auto"><p class="text-xl leading-relaxed mb-6">What began as a small team built on strong values has grown into a trusted traffic control company known for <strong>integrity, precision, and care.</strong></p><p class="text-lg text-gray-600 mb-6">We founded T&S to raise the standard of safety and respect in our industry — not just to offer a service.</p><div class="bg-blue-50 border border-blue-200 rounded-2xl p-6"><p class="text-lg font-medium text-gray-700">Our mission is to <strong>protect lives</strong> and create a workplace where every team member can <strong>grow, lead, and deliver safe outcomes</strong> for the public, workers, and pedestrians.</p></div></div>',
    layout: 'content',
    icon: '🏢'
  },
  {
    ...
    subtitle: 'Taj & Saadat',
    content: '<div class="max-w-3xl mx-auto"><div class="bg-teal-500 text-white rounded-2xl p-8"><p class="text-xl leading-relaxed mb-4">Lifelong friends turned business partners, they founded the company with a shared vision — to lift the standard of safety, professionalism, and opportunity.</p><p class="text-lg opacity-90 mb-4">From humble beginnings, they built T&S through hard work, trust, and a deep sense of responsibility to both clients and their team.</p><p class="text-lg opacity-90">Their leadership goes beyond operations — they\'re dedicated to building a workplace that <strong>develops, supports, and empowers</strong> people to grow, lead, and succeed.</p></div></div>',
    layout: 'content',
    icon: '👥'
  },
  {
    ...
    content: '<div class="grid md:grid-cols-3 gap-6"><div class="bg-orange-500 text-white rounded-xl p-6 text-center"><div class="text-4xl mb-3">🏗️</div><p class="font-bold text-lg mb-2">Hospital Roundabout</p><p class="opacity-90">Concord Hospital Roundabout & Stormwater Upgrade Project</p></div><div class="bg-blue-600 text-white rounded-xl p-6 text-center"><div class="text-4xl mb-3">🏨</div><p class="font-bold text-lg mb-2">Hotel Construction</p><p class="opacity-90">Wentworth Avenue Hotel Construction Traffic Management</p></div><div class="bg-green-600 text-white rounded-xl p-6 text-center"><div class="text-4xl mb-3">🛣️</div><p class="font-bold text-lg mb-2">Road Upgrades</p><p class="opacity-90">Wallendbeen Road Pavement Upgrade Project</p></div></div>',
    layout: 'split',
    icon: '🏆'
  },
  {
    ...
    content: '<div class="grid md:grid-cols-3 gap-6"><div class="bg-blue-50 rounded-xl p-6 border-l-4 border-blue-600"><div class="text-3xl font-bold text-blue-600 mb-2">1</div><p class="font-semibold mb-2 text-gray-900">Valid Credentials</p><p class="text-gray-600">Hold a valid White Card and Traffic Controller RMS/TfNSW accreditation at all times.</p></div><div class="bg-green-50 rounded-xl p-6 border-l-4 border-green-600"><div class="text-3xl font-bold text-green-600 mb-2">2</div><p class="font-semibold mb-2 text-gray-900">WHS Compliance</p><p class="text-gray-600">Follow the WHS Act 2011 (NSW) and all RMS/TfNSW standards.</p></div><div class="bg-orange-50 rounded-xl p-6 border-l-4 border-orange-500"><div class="text-3xl font-bold text-orange-500 mb-2">3</div><p class="font-semibold mb-2 text-gray-900">Documentation</p><p class="text-gray-600">Read and sign all SWMS and TMP before work (when required).</p></div></div>',
    layout: 'split',
    icon: '⚖️'
  },
  {
    ...
    content: '<div class="grid grid-cols-2 gap-6"><div class="bg-orange-500 text-white rounded-xl p-6"><p class="text-2xl mb-2">🤝</p><p class="font-bold text-lg mb-2">Respect</p><p class="opacity-90">Respect colleagues and the public at all times.</p></div><div class="bg-blue-600 text-white rounded-xl p-6"><p class="text-2xl mb-2">🚨</p><p class="font-bold text-lg mb-2">Report</p><p class="opacity-90">Report unsafe actions or incidents immediately to admin.</p></div><div class="bg-purple-600 text-white rounded-xl p-6"><p class="text-2xl mb-2">🚫</p><p class="font-bold text-lg mb-2">Zero Tolerance</p><p class="opacity-90">Zero tolerance for all forms of harassment or bullying.</p></div><div class="bg-teal-500 text-white rounded-xl p-6"><p class="text-2xl mb-2">💼</p><p class="font-bold text-lg mb-2">Professional</p><p class="opacity-90">Keep sites professional — no relationships between supervisors and subordinates.</p></div></div>',
    layout: 'split',
    icon: '💎'
  },
  {
    ...
    content: '<div class="text-center"><p class="text-xl text-gray-600 mb-8">PPE protects you from traffic, machinery and weather. It is a <strong>legal requirement</strong> under NSW WHS regulations.</p><div class="grid md:grid-cols-3 gap-6 max-w-3xl mx-auto"><div class="bg-amber-500 text-white rounded-xl p-6"><p class="text-3xl mb-2">👷</p><p class="font-bold">Hard Hat</p><p class="text-sm opacity-90">All job sites</p></div><div class="bg-green-600 text-white rounded-xl p-6"><p class="text-3xl mb-2">🦺</p><p class="font-bold">Hi-Vis Clothing</p><p class="text-sm opacity-90">Class D/N day & night</p></div><div class="bg-blue-600 text-white rounded-xl p-6"><p class="text-3xl mb-2">🥾</p><p class="font-bold">Steel-Cap Boots</p><p class="text-sm opacity-90">Ankle-supportive, slip-resistant</p></div></div></div>',
    layout: 'highlight',
    icon: '🦺'
  },
  {
    ...
    subtitle: '',
    content: '<div class="max-w-3xl mx-auto"><div class="bg-gray-50 border border-gray-200 rounded-xl p-6 mb-6"><p class="font-bold text-lg mb-3 text-gray-900">Optional PPE (when required):</p><ul class="grid grid-cols-2 gap-3 text-gray-700"><li>🧤 Gloves — handling equipment, extreme weather</li><li>🥽 Safety glasses — dust, debris, sun glare</li><li>🎧 Hearing protection — near loud machinery</li><li>🧥 Wet-weather gear — adverse conditions</li></ul></div><div class="bg-red-600 text-white rounded-xl p-6"><p class="text-xl font-bold mb-2">⚠️ Compliance & Disciplinary Actions</p><p class="text-lg">Failure to wear PPE correctly can result in <strong>warnings, suspension, or removal from site.</strong></p><p class="opacity-90 mt-2">Always follow supervisor instructions regarding PPE requirements.</p></div></div>',
    layout: 'content',
    icon: '⚠️'
  },
  {
    ...
    content: '<div class="max-w-3xl mx-auto"><p class="text-xl text-gray-600 mb-6">Traffio is our app for allocating and rostering all employees. It provides job site info, resources, location, TGS, ROL and all safety documents.</p><div class="bg-blue-50 border border-blue-200 rounded-xl p-6 space-y-4"><div class="flex items-start gap-4"><div class="w-8 h-8 bg-blue-600 text-white rounded-full flex items-center justify-center font-bold flex-shrink-0">1</div><div><p class="font-semibold text-gray-900">Log in details sent to your email</p></div></div><div class="flex items-start gap-4"><div class="w-8 h-8 bg-blue-600 text-white rounded-full flex items-center justify-center font-bold flex-shrink-0">2</div><div><p class="font-semibold text-gray-900">Receive allocations per day for the following day</p></div></div><div class="flex items-start gap-4"><div class="w-8 h-8 bg-blue-600 text-white rounded-full flex items-center justify-center font-bold flex-shrink-0">3</div><div><p class="font-semibold text-gray-900">Accept or reject the shift — if you reject, notify your allocator</p></div></div><div class="flex items-start gap-4"><div class="w-8 h-8 bg-red-600 text-white rounded-full flex items-center justify-center font-bold flex-shrink-0">!</div><div><p class="font-semibold text-red-600">ALL employees must have notifications ON!</p></div></div></div></div>',
    layout: 'content',
    icon: '📱'
  },
  {
    ...
    content: '<div class="grid md:grid-cols-3 gap-4"><div class="bg-blue-600 text-white rounded-xl p-5 text-center"><div class="text-2xl font-bold mb-2">Step 1</div><p class="font-semibold">Receive Job Request</p><p class="text-sm opacity-90 mt-1">Booking time = start time on site</p></div><div class="bg-blue-600 text-white rounded-xl p-5 text-center"><div class="text-2xl font-bold mb-2">Step 2</div><p class="font-semibold">Review & Accept</p><p class="text-sm opacity-90 mt-1">Check details and confirm</p></div><div class="bg-blue-600 text-white rounded-xl p-5 text-center"><div class="text-2xl font-bold mb-2">Step 3</div><p class="font-semibold">Read Description</p><p class="text-sm opacity-90 mt-1">Contact crew booking</p></div><div class="bg-green-600 text-white rounded-xl p-5 text-center"><div class="text-2xl font-bold mb-2">Step 4</div><p class="font-semibold">Review Site Docs</p><p class="text-sm opacity-90 mt-1">All safety documentation</p></div><div class="bg-green-600 text-white rounded-xl p-5 text-center"><div class="text-2xl font-bold mb-2">Step 5</div><p class="font-semibold">Fill Checklists</p><p class="text-sm opacity-90 mt-1">Complete during every job</p></div><div class="bg-green-600 text-white rounded-xl p-5 text-center"><div class="text-2xl font-bold mb-2">Step 6</div><p class="font-semibold">Submit Timesheet</p><p class="text-sm opacity-90 mt-1">Client MUST sign timesheet</p></div></div>',
    layout: 'split',
    icon: '📋'
  },
  {
    ...
    content: '<div class="max-w-3xl mx-auto"><p class="text-lg text-gray-600 mb-6">On the bottom of the Traffio screen, tap the "Forms" tab. Always submit a form and follow up with your supervisor via phone call.</p><div class="grid md:grid-cols-2 gap-4"><div class="bg-teal-500 text-white rounded-xl p-5 flex items-center gap-4"><span class="text-2xl">🏖️</span><div><p class="font-semibold">Leave Request</p><p class="text-sm opacity-90">Submit at least 2 days before</p></div></div><div class="bg-orange-500 text-white rounded-xl p-5 flex items-center gap-4"><span class="text-2xl">⚠️</span><div><p class="font-semibold">Near-Miss Report</p><p class="text-sm opacity-90">Report immediately</p></div></div><div class="bg-red-600 text-white rounded-xl p-5 flex items-center gap-4"><span class="text-2xl">🚑</span><div><p class="font-semibold">Accident Report</p><p class="text-sm opacity-90">Complete as soon as possible</p></div></div><div class="bg-blue-600 text-white rounded-xl p-5 flex items-center gap-4"><span class="text-2xl">📸</span><div><p class="font-semibold">Extra Site Photos</p><p class="text-sm opacity-90">Upload for documentation</p></div></div></div></div>',
    layout: 'content',
    icon: '📝'
  },
  {
    ...
    content: '<div class="max-w-3xl mx-auto"><p class="text-xl mb-6 text-gray-900">At T&S, we expect our traffic controllers to treat all road users, pedestrians and clients with <strong>utmost respect and manners.</strong></p><div class="space-y-4"><div class="bg-green-50 rounded-xl p-5 border-l-4 border-green-600"><p class="text-lg italic text-gray-700">"Good morning/afternoon! Please wait here for a moment; I\'ll let you know when it\'s safe to go."</p></div><div class="bg-green-50 rounded-xl p-5 border-l-4 border-green-600"><p class="text-lg italic text-gray-700">"Alright, you\'re good to go! Watch your step and have a great day!"</p></div><div class="bg-green-50 rounded-xl p-5 border-l-4 border-green-600"><p class="text-lg italic text-gray-700">"Thanks for your patience! You can cross now — stay safe!"</p></div></div><p class="text-lg text-gray-600 mt-6 text-center">Being polite and using a friendly tone creates an <strong>impactful difference.</strong></p></div>',
    layout: 'content',
    icon: '💬'
  },
  {
    ...
    content: '<div class="max-w-3xl mx-auto"><div class="bg-red-600 text-white rounded-2xl p-8 text-center mb-6"><p class="text-5xl mb-4">📵</p><p class="text-2xl font-bold">NO PHONES ON SITE</p></div><div class="grid md:grid-cols-2 gap-4"><div class="bg-red-50 border border-red-200 rounded-xl p-5"><p class="font-semibold text-red-700 mb-1">Reduced Awareness</p><p class="text-gray-600">Must remain fully focused on vehicle and pedestrian movements</p></div><div class="bg-red-50 border border-red-200 rounded-xl p-5"><p class="font-semibold text-red-700 mb-1">Delayed Reactions</p><p class="text-gray-600">A momentary distraction can lead to accidents</p></div><div class="bg-red-50 border border-red-200 rounded-xl p-5"><p class="font-semibold text-red-700 mb-1">Miscommunication</p><p class="text-gray-600">Missed radio communications or misunderstood instructions</p></div><div class="bg-red-50 border border-red-200 rounded-xl p-5"><p class="font-semibold text-red-700 mb-1">Legal Issues</p><p class="text-gray-600">NSW regulations require full alertness — fines, termination, or liability</p></div></div></div>',
    layout: 'highlight',
    icon: '📵'
  },
  {
    ...
    content: '<div class="grid md:grid-cols-3 gap-6"><div class="bg-blue-600 text-white rounded-xl p-6"><p class="text-xl font-bold mb-3">1. Pre-Start</p><ul class="space-y-2 opacity-90"><li>✓ Check lights, brakes, fuel, oil, tyres</li><li>✓ Verify traffic control equipment</li><li>✓ Secure all tools and equipment</li><li>✓ Always wear a seatbelt</li></ul></div><div class="bg-green-600 text-white rounded-xl p-6"><p class="text-xl font-bold mb-3">2. Defensive Driving</p><ul class="space-y-2 opacity-90"><li>✓ Follow all road rules and speed limits</li><li>✓ Drive to weather conditions</li><li>✓ Maintain safe following distance</li><li>✓ Stay alert near work zones</li></ul></div><div class="bg-orange-500 text-white rounded-xl p-6"><p class="text-xl font-bold mb-3">3. Warning Signals</p><ul class="space-y-2 opacity-90"><li>✓ Activate beacons near traffic zones</li><li>✓ Use indicators early</li><li>✓ Only use horn when necessary</li></ul></div></div>',
    layout: 'split',
    icon: '🚗'
  },
  {
    ...
    content: '<div class="max-w-3xl mx-auto space-y-4"><div class="bg-gray-50 border border-gray-200 rounded-xl p-5 flex items-center gap-4"><span class="text-2xl">📏</span><p class="text-gray-900">Maximum vehicle height is <strong>2.5 metres</strong></p></div><div class="bg-gray-50 border border-gray-200 rounded-xl p-5 flex items-center gap-4"><span class="text-2xl">🅿️</span><p class="text-gray-900">No parking in car parks or near shops</p></div><div class="bg-gray-50 border border-gray-200 rounded-xl p-5 flex items-center gap-4"><span class="text-2xl">🚛</span><p class="text-gray-900">Utes must remain on site — no leaving unless client grants permission</p></div><div class="bg-gray-50 border border-gray-200 rounded-xl p-5 flex items-center gap-4"><span class="text-2xl">🚭</span><p class="text-gray-900">No eating or smoking inside company vehicles</p></div><div class="bg-red-600 text-white rounded-xl p-5"><p class="font-bold mb-2">⚠️ Accident Liability</p><p>Report must be completed immediately in Traffio. If driver at fault: vehicle insurance excess is <strong>$2,000</strong> (under 25). Cage/arrowboard excess is <strong>$1,000</strong> (under 25).</p></div></div>',
    layout: 'list',
    icon: '🚛'
  },
  {
    ...
    subtitle: '',
    content: '<div class="max-w-3xl mx-auto"><div class="grid md:grid-cols-2 gap-6"><div class="bg-blue-50 border border-blue-200 rounded-xl p-6"><p class="text-4xl text-center mb-4">🛣️</p><p class="text-center font-bold text-lg mb-2 text-gray-900">Lane Discipline</p><p class="text-gray-600 text-center">On highways, drive <strong>only in the slow or middle lanes.</strong> Never use the fast (right-hand) lane under any circumstances.</p></div><div class="bg-green-50 border border-green-200 rounded-xl p-6"><p class="text-4xl text-center mb-4">🐢</p><p class="text-center font-bold text-lg mb-2 text-gray-900">Speed Management</p><p class="text-gray-600 text-center">Maintain a speed approximately <strong>10 km/h below the posted limit.</strong> Your vehicle carries up to 500 kg of load.</p></div></div><div class="bg-amber-500 text-white rounded-xl p-6 mt-6 text-center"><p class="text-lg font-bold">Avoid harsh braking — your vehicle carries up to 500 kg of load weight at all times.</p></div></div>',
    layout: 'split',
    icon: '🚦'
  },
  {
    ...
    content: '<div class="max-w-3xl mx-auto"><div class="bg-red-600 text-white rounded-xl p-6 mb-6"><p class="text-xl font-bold mb-3">Sexual Harassment Policy</p><ul class="space-y-2 opacity-90"><li>🚫 Zero tolerance for inappropriate jokes, comments, touching, or advances</li><li>🔒 Any report is taken seriously and investigated confidentially</li><li>⚖️ Offenders may be removed from site or face termination</li></ul></div><div class="bg-gray-50 border border-gray-200 rounded-xl p-6 mb-6"><p class="font-bold text-lg mb-3 text-gray-900">Relationships on Site</p><ul class="space-y-2 text-gray-700"><li>• Romantic relationships must be declared to management</li><li>• No displays of affection on site — keep it professional</li><li>• Managers/supervisors cannot be in relationships with direct subordinates</li></ul></div><div class="bg-blue-600 text-white rounded-xl p-5 text-center"><p class="font-semibold">Speak to HR or the designated contact officer if you feel unsafe. Anonymous reports can also be made.</p></div></div>',
    layout: 'content',
    icon: '🛡️'
  },
  {
    ...
    content: '<div class="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto"><div class="bg-red-600 text-white rounded-xl p-6 text-center"><p class="text-4xl mb-3">🧯</p><p class="font-bold text-lg mb-2">Fire Extinguisher</p><p class="opacity-90">Located on the ute\'s cage — passenger side</p></div><div class="bg-green-600 text-white rounded-xl p-6 text-center"><p class="text-4xl mb-3">🩹</p><p class="font-bold text-lg mb-2">First Aid Kit</p><p class="opacity-90">Passenger side glove box or behind passenger seat</p></div><div class="bg-amber-500 text-white rounded-xl p-6 text-center"><p class="text-4xl mb-3">⛽</p><p class="font-bold text-lg mb-2">Fuel Card</p><p class="opacity-90">Sunglass holder, glove box or centre console — T&S VEHICLE USE ONLY</p></div><div class="bg-sky-500 text-white rounded-xl p-6 text-center"><p class="text-4xl mb-3">🔑</p><p class="font-bold text-lg mb-2">Keys</p><p class="opacity-90">Must go into the lock box, next to stop/slow bats</p></div></div>',
    layout: 'split',
    icon: '🩹'
  },
  {
    ...
    content: '<div class="grid md:grid-cols-4 gap-4 max-w-4xl mx-auto"><div class="bg-red-600 text-white rounded-xl p-6 text-center"><p class="text-4xl font-bold mb-2">P</p><p class="font-bold text-lg mb-2">PULL</p><p class="opacity-90">Pull pin at the top, breaking the seal. Test aiming away from you.</p></div><div class="bg-orange-500 text-white rounded-xl p-6 text-center"><p class="text-4xl font-bold mb-2">A</p><p class="font-bold text-lg mb-2">AIM</p><p class="opacity-90">Approach from a safe distance. Aim at the base of the fire.</p></div><div class="bg-green-600 text-white rounded-xl p-6 text-center"><p class="text-4xl font-bold mb-2">S</p><p class="font-bold text-lg mb-2">SQUEEZE</p><p class="opacity-90">Squeeze handles together to discharge. Release to stop.</p></div><div class="bg-blue-600 text-white rounded-xl p-6 text-center"><p class="text-4xl font-bold mb-2">S</p><p class="font-bold text-lg mb-2">SWEEP</p><p class="opacity-90">Sweep nozzle side to side at the base of the flames.</p></div></div>',
    layout: 'split',
    icon: '🧯'
  },
  {
    ...
    content: '<div class="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto"><div class="bg-blue-50 rounded-xl p-6 border-l-4 border-blue-600"><p class="text-lg font-bold mb-2 text-gray-900">Question 1</p><p class="text-gray-600">What is the compulsory PPE for every job site?</p></div><div class="bg-green-50 rounded-xl p-6 border-l-4 border-green-600"><p class="text-lg font-bold mb-2 text-gray-900">Question 2</p><p class="text-gray-600">What is the company motto?</p></div><div class="bg-orange-50 rounded-xl p-6 border-l-4 border-orange-500"><p class="text-lg font-bold mb-2 text-gray-900">Question 3</p><p class="text-gray-600">Where is the fire extinguisher located on every ute?</p></div><div class="bg-red-50 rounded-xl p-6 border-l-4 border-red-600"><p class="text-lg font-bold mb-2 text-gray-900">Question 4</p><p class="text-gray-600">How many days earlier should you notify the company about short-term leave?</p></div></div>',
    layout: 'quiz',
    icon: '❓'
  },
];
