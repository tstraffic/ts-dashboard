...
const employeeGuideSlides = [
  ...
  // ── Slide 2: Mission ──
  {
    title: 'T&S Mission',
    subtitle: '"A Safe Way Home"',
    content: '<div style="display:grid;grid-template-columns:1fr 1fr;gap:2rem;align-items:center;"><div><div style="border-left:3px solid var(--cyan);padding-left:16px;margin-bottom:16px;"><p style="font-size:22px;line-height:1.5;color:var(--cyan);font-weight:600;">T&S Traffic Control — "A Safe Way Home."</p></div><p style="color:rgba(255,255,255,0.72);font-size:16px;margin-bottom:16px;">Family-owned since 2021 — raising standards of safety, professionalism, and respect in NSW traffic control.</p><p style="color:rgba(255,255,255,0.72);font-size:16px;">ISO-certified, built to make a difference.</p></div><div style="display:flex;gap:1rem;justify-content:center;align-items:center;flex-wrap:wrap;"><img src="/images/slides/iso-9001.png" alt="ISO 9001" style="height:100px;border-radius:10px;box-shadow:0 4px 16px rgba(0,0,0,0.4);"><img src="/images/slides/iso-14001.png" alt="ISO 14001" style="height:100px;border-radius:10px;box-shadow:0 4px 16px rgba(0,0,0,0.4);"><img src="/images/slides/iso-45001.png" alt="ISO 45001" style="height:100px;border-radius:10px;box-shadow:0 4px 16px rgba(0,0,0,0.4);"></div></div>',
    layout: 'content',
    icon: ''
  },
  // ── Slide 3: Who We Are ──
  ...
  // ── Slide 5: Accomplishments ──
  {
    ...
    subtitle: '',
    content: '<div style="display:grid;grid-template-columns:1fr 1fr;gap:2rem;align-items:center;"><div><div style="border-left:2px solid rgba(0,210,190,0.3);padding-left:16px;margin-bottom:20px;"><p style="font-weight:600;font-size:16px;color:white;">Concord Hospital</p><p style="color:rgba(255,255,255,0.5);font-size:14px;">Roundabout & Stormwater Upgrade Project</p></div><div style="border-left:2px solid rgba(0,210,190,0.3);padding-left:16px;margin-bottom:20px;"><p style="font-weight:600;font-size:16px;color:white;">Wentworth Avenue</p><p style="color:rgba(255,255,255,0.5);font-size:14px;">Hotel Construction Traffic Management</p></div><div style="border-left:2px solid rgba(0,210,190,0.3);padding-left:16px;"><p style="font-weight:600;font-size:16px;color:white;">Wallendbeen</p><p style="color:rgba(255,255,255,0.5);font-size:14px;">Road Pavement Upgrade Project</p></div></div><div><img src="/images/slides/projects-collage.png" alt="T&S Projects" style="width:100%;max-height:450px;object-fit:contain;border-radius:12px;box-shadow:0 8px 32px rgba(0,0,0,0.5);"></div></div>',
    layout: 'content',
    icon: ''
  },
  ...
  // ── PPE Title ──
  {
    ...
    subtitle: '',
    content: '<div style="text-align:center;"><p style="font-size:16px;color:rgba(255,255,255,0.72);margin-bottom:2rem;">PPE protects you from traffic, machinery and weather — it\'s your <strong style="font-weight:600;">last line of defence.</strong><br>It is a <strong style="font-weight:600;">legal requirement</strong> under NSW WHS regulations.</p><div style="display:flex;gap:1.5rem;justify-content:center;align-items:flex-end;flex-wrap:wrap;"><div style="text-align:center;"><div style="background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:16px;margin-bottom:0.75rem;display:inline-block;"><img src="/images/slides/hard-hat.png" alt="Hard Hat" style="height:65px;display:block;"></div><p style="font-weight:600;font-size:15px;color:white;">Hard Hat</p><p style="font-size:13px;color:rgba(255,255,255,0.45);">All job sites</p></div><div style="text-align:center;"><div style="background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:16px;margin-bottom:0.75rem;display:inline-block;"><img src="/images/slides/hivis-jacket.png" alt="Hi-Vis" style="height:80px;display:block;"></div><p style="font-weight:600;font-size:15px;color:white;">Hi-Vis Clothing</p><p style="font-size:13px;color:rgba(255,255,255,0.45);">Class D/N day & night</p></div><div style="text-align:center;"><div style="background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:16px;margin-bottom:0.75rem;display:inline-block;"><img src="/images/slides/hivis-pants-navy.png" alt="Pants" style="height:90px;display:block;"></div><p style="font-weight:600;font-size:15px;color:white;">Hi-Vis Pants</p><p style="font-size:13px;color:rgba(255,255,255,0.45);">With reflective tape</p></div><div style="text-align:center;"><div style="background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:16px;margin-bottom:0.75rem;display:inline-block;"><img src="/images/slides/wand-baton.png" alt="Wand" style="height:75px;display:block;"></div><p style="font-weight:600;font-size:15px;color:white;">Wand / Baton</p><p style="font-size:13px;color:rgba(255,255,255,0.45);">Night work</p></div><div style="text-align:center;"><div style="background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:16px;margin-bottom:0.75rem;display:inline-block;"><img src="/images/slides/two-way-radio.png" alt="Radio" style="height:80px;display:block;"></div><p style="font-weight:600;font-size:15px;color:white;">Two-Way Radio</p><p style="font-size:13px;color:rgba(255,255,255,0.45);">Communication</p></div></div></div>',
    layout: 'content',
    icon: ''
  },
  // ── Slide 9: PPE Details ──
  ...
  // ── Slide 11: Traffio Steps 1-3 ──
  {
    ...
    content: '<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:1.5rem;align-items:start;"><div style="text-align:center;"><div style="color:var(--cyan);font-size:11px;letter-spacing:0.1em;font-weight:700;margin-bottom:0.75rem;">STEP 1</div><img src="/images/slides/traffio-jobs.png" alt="Job list" style="width:100%;border-radius:12px;border:1px solid rgba(255,255,255,0.08);box-shadow:0 8px 32px rgba(0,0,0,0.6);margin-bottom:0.75rem;max-height:260px;object-fit:contain;"><p style="font-weight:600;font-size:15px;color:white;">Receive Job Request</p><p style="font-size:13px;color:rgba(255,255,255,0.45);margin-top:0.25rem;">Booking time is start time on site</p></div><div style="text-align:center;"><div style="color:var(--cyan);font-size:11px;letter-spacing:0.1em;font-weight:700;margin-bottom:0.75rem;">STEP 2</div><img src="/images/slides/traffio-accept.png" alt="Accept job" style="width:100%;border-radius:12px;border:1px solid rgba(255,255,255,0.08);box-shadow:0 8px 32px rgba(0,0,0,0.6);margin-bottom:0.75rem;max-height:260px;object-fit:contain;"><p style="font-weight:600;font-size:15px;color:white;">Review & Accept Job</p><p style="font-size:13px;color:rgba(255,255,255,0.45);margin-top:0.25rem;">Check details and confirm</p></div><div style="text-align:center;"><div style="color:var(--cyan);font-size:11px;letter-spacing:0.1em;font-weight:700;margin-bottom:0.75rem;">STEP 3</div><img src="/images/slides/traffio-details.png" alt="Read details" style="width:100%;border-radius:12px;border:1px solid rgba(255,255,255,0.08);box-shadow:0 8px 32px rgba(0,0,0,0.6);margin-bottom:0.75rem;max-height:260px;object-fit:contain;"><p style="font-weight:600;font-size:15px;color:white;">Read Description & Contact Crew</p><p style="font-size:13px;color:rgba(255,255,255,0.45);margin-top:0.25rem;">Review all job info</p></div></div>',
    layout: 'split',
    icon: ''
  },
  // ── Slide 12: Traffio Steps 4-6 ──
  {
    ...
    content: '<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:1.5rem;align-items:start;"><div style="text-align:center;"><div style="color:var(--cyan);font-size:11px;letter-spacing:0.1em;font-weight:700;margin-bottom:0.75rem;">STEP 4</div><img src="/images/slides/traffio-docs.png" alt="Site docs" style="width:100%;border-radius:0.75rem;border:1px solid rgba(255,255,255,0.08);box-shadow:0 8px 32px rgba(0,0,0,0.6);margin-bottom:0.75rem;max-height:260px;object-fit:contain;"><p style="font-weight:600;">Review All Site Docs</p><p style="font-size:0.9rem;color:var(--text-secondary);margin-top:0.25rem;">TGS, ROL, safety documents</p></div><div style="text-align:center;"><div style="color:var(--cyan);font-size:11px;letter-spacing:0.1em;font-weight:700;margin-bottom:0.75rem;">STEP 5</div><img src="/images/slides/traffio-forms-tab.png" alt="Checklists" style="width:100%;border-radius:0.75rem;border:1px solid rgba(255,255,255,0.08);box-shadow:0 8px 32px rgba(0,0,0,0.6);margin-bottom:0.75rem;max-height:260px;object-fit:contain;"><p style="font-weight:600;">Fill Checklist Forms</p><p style="font-size:0.9rem;color:var(--text-secondary);margin-top:0.25rem;">Complete during every job</p></div><div style="text-align:center;"><div style="color:var(--cyan);font-size:11px;letter-spacing:0.1em;font-weight:700;margin-bottom:0.75rem;">STEP 6</div><img src="/images/slides/traffio-timesheet.png" alt="Timesheet" style="width:100%;border-radius:0.75rem;border:1px solid rgba(255,255,255,0.08);box-shadow:0 8px 32px rgba(0,0,0,0.6);margin-bottom:0.75rem;max-height:260px;object-fit:contain;"><p style="font-weight:600;">Submit Signed Timesheet</p><p style="font-size:13px;color:var(--ts-red);margin-top:0.25rem;font-weight:700;">Client MUST sign timesheet!</p></div></div>',
    layout: 'split',
    icon: ''
  },
  // ── Slide 13: Forms ──
  {
    ...
    subtitle: '',
    content: '<div style="display:grid;grid-template-columns:1fr 1fr;gap:2rem;align-items:center;"><div><p style="font-size:15px;line-height:1.7;color:rgba(255,255,255,0.72);margin-bottom:1.5rem;">On Traffio, tap the <strong>"Forms"</strong> tab at the bottom of the screen. Always submit a form and follow it up with your supervisor via phone call.</p><div style="display:grid;gap:0.75rem;"><div style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:8px;padding:10px 14px;display:flex;align-items:center;gap:0.75rem;border-left:3px solid var(--ts-teal);"><span style="font-size:1.2rem;">🏖️</span><span style="font-weight:600;">Leave Request</span></div><div style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:8px;padding:10px 14px;display:flex;align-items:center;gap:0.75rem;border-left:3px solid var(--ts-orange);"><span style="font-size:1.2rem;">⚠️</span><span style="font-weight:600;">Near Miss Investigation Form</span></div><div style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:8px;padding:10px 14px;display:flex;align-items:center;gap:0.75rem;border-left:3px solid var(--ts-red);"><span style="font-size:1.2rem;">🚑</span><span style="font-weight:600;">On-Site Incident Report Form</span></div><div style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:8px;padding:10px 14px;display:flex;align-items:center;gap:0.75rem;border-left:3px solid var(--ts-blue);"><span style="font-size:1.2rem;">🚗</span><span style="font-weight:600;">Vehicle Incident Report Form</span></div><div style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:8px;padding:10px 14px;display:flex;align-items:center;gap:0.75rem;border-left:3px solid var(--ts-purple);"><span style="font-size:1.2rem;">📸</span><span style="font-weight:600;">Site / Vehicle Equipment Count</span></div></div></div><div style="text-align:center;"><img src="/images/slides/traffio-forms.png" alt="Forms Tab" style="max-height:400px;border-radius:12px;border:1px solid rgba(255,255,255,0.08);box-shadow:0 8px 32px rgba(0,0,0,0.6);"></div></div>',
    layout: 'content',
    icon: ''
  },
  // ── Slide 14: Leave ──
