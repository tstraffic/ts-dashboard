...
const employeeGuideSlides = [
  ...
  // ── PPE Title ──
  {
    ...
    subtitle: '',
    content: '<div style="text-align:center;"><p style="font-size:16px;color:rgba(255,255,255,0.72);margin-bottom:1.5rem;">PPE protects you from traffic, machinery and weather — it\'s your <strong style="font-weight:600;">last line of defence.</strong><br>It is a <strong style="font-weight:600;">legal requirement</strong> under NSW WHS regulations.</p><div class="ppe-grid"><div class="ppe-item"><div class="ppe-slot"><img src="/images/slides/hard-hat.png" alt="Hard Hat" class="ppe-img"></div><p class="ppe-label">Hard Hat</p><p class="ppe-sub">All job sites</p></div><div class="ppe-item"><div class="ppe-slot"><img src="/images/slides/hivis-jacket.png" alt="Hi-Vis" class="ppe-img"></div><p class="ppe-label">Hi-Vis Clothing</p><p class="ppe-sub">Class D/N day & night</p></div><div class="ppe-item"><div class="ppe-slot"><img src="/images/slides/hivis-pants-navy.png" alt="Pants" class="ppe-img"></div><p class="ppe-label">Hi-Vis Pants</p><p class="ppe-sub">Reflective tape</p></div><div class="ppe-item"><div class="ppe-slot"><img src="/images/slides/wand-baton.png" alt="Wand" class="ppe-img"></div><p class="ppe-label">Wand / Baton</p><p class="ppe-sub">Night work</p></div><div class="ppe-item"><div class="ppe-slot"><img src="/images/slides/two-way-radio.png" alt="Radio" class="ppe-img"></div><p class="ppe-label">Two-Way Radio</p><p class="ppe-sub">Communication</p></div></div></div>',
    layout: 'content',
    icon: ''
  },
  // ── Slide 9: PPE Details ──
  ...
  // ── Slide 11: Traffio Steps 1-3 ──
  {
    ...
    content: '<div class="steps-grid"><div class="step-card"><div class="step-label">STEP 1</div><img src="/images/slides/traffio-jobs.png" alt="Job list" class="step-img"><p class="step-title">Receive Job Request</p><p class="step-desc">Booking time is start time on site</p></div><div class="step-card"><div class="step-label">STEP 2</div><img src="/images/slides/traffio-accept.png" alt="Accept job" class="step-img"><p class="step-title">Review & Accept Job</p><p class="step-desc">Check details and confirm</p></div><div class="step-card"><div class="step-label">STEP 3</div><img src="/images/slides/traffio-details.png" alt="Read details" class="step-img"><p class="step-title">Read Description & Contact Crew</p><p class="step-desc">Review all job info</p></div></div>',
    layout: 'split',
    icon: ''
  },
  // ── Slide 12: Traffio Steps 4-6 ──
  {
    ...
    content: '<div class="steps-grid"><div class="step-card"><div class="step-label">STEP 4</div><img src="/images/slides/traffio-docs.png" alt="Site docs" class="step-img"><p class="step-title">Review All Site Docs</p><p class="step-desc">TGS, ROL, safety documents</p></div><div class="step-card"><div class="step-label">STEP 5</div><img src="/images/slides/traffio-forms-tab.png" alt="Checklists" class="step-img"><p class="step-title">Fill Checklist Forms</p><p class="step-desc">Complete during every job</p></div><div class="step-card"><div class="step-label">STEP 6</div><img src="/images/slides/traffio-timesheet.png" alt="Timesheet" class="step-img"><p class="step-title">Submit Signed Timesheet</p><p class="step-desc step-desc-red">Client MUST sign timesheet!</p></div></div>',
    layout: 'split',
    icon: ''
  },
  // ── Slide 13: Forms ──
